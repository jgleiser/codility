...
/*
	Keep currentMax at the maximum value
	Set minValue to the minimum value that every counter needs
	At the end, check if there is a counter under the minValue
*/
